...
差別化：学習全般でプログラミング学習に特化しておらず、SNS連携は限定的。ユーザー登録・ログインなしでは使用出来ない。  

habitica  
https://habitica.com/static/home  
タスク管理とRPG風のガミフィケーションを融合。学習や習慣を「クエスト」として記録し、キャラクターを育成。コミュニティ機能で仲間と協力可能。  
類似点：学習記録、キャラクター育成、チェックボックス形式でタスク管理  
差別化：学習全般でプログラミング学習に特化しておらず、GitHubやSNS（X/Mattermost）連携がない。ユーザー登録・ログインなしでは使用出来ない。  
...
【差別化ポイントと優位性】  
(1)ログイン不要でX(Twitter)やMattermostに投稿可  
面倒な登録不要で試せる敷居の低さ。  
(2)学習記録＋SNSの同時実行  
コミュニティとの接点が自然に生まれ、孤独感の解消、仲間探しにつながる。  
(3)キャラクター育成要素  
勉強すれば「使い魔」が成長、「結果が目に見える」ことでモチベーション維持と感情的な繋がりが出来る。  
